...
function displayFatalError(rootElement, error) {
    ...
    if (error instanceof VersionError) {
        ...
        message = 'به نظر می‌رسد نسخه دیگری از «پیک» در یک تب دیگر باز است که مانع از بارگذاری این صفحه می‌شود. لطفاً تمام تب‌های دیگر این برنامه را بسته و سپس صفحه را مجدداً بارگیری کنید.';
